...
function isReadyReferenceAsset(asset: ProductionAsset): boolean {
  return Boolean(asset.url.trim()) && (asset.status === "approved" || asset.status === "ready");
}

function isCharacterDesignAsset(asset: ProductionAsset): boolean {
  return asset.type === "character_design";
}

function isBackgroundDesignAsset(asset: ProductionAsset): boolean {
  return asset.type === "scene_design" || asset.type === "style_reference" || asset.type === "first_frame";
}

function buildAssetContextBrief(characterAsset: ProductionAsset | null, backgroundAsset: ProductionAsset | null): string {
  const lines = [
    characterAsset
      ? [
...
function productionAssetToGenerationReference(asset: ProductionAsset): GenerationReferenceAsset | null {
